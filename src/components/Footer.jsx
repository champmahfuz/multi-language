    ...
    <footer className="main-footer">
      <div className="footer-items">
        <div>
          ...
          <a href={"/" + props.langName + "/services"}>
            {resources[props.langName].Services}
          </a>
          <a href={"/" + props.langName + "/contact"}>
            {resources[props.langName].Contact}
          </a>
          <a href={"/" + props.langName + "/privacy"}>
            {resources[props.langName].Privacy}
          </a>
          <a href={"/" + props.langName + "/about"}>
            {resources[props.langName].About}
          </a>
        </div>
      ...
      <div className="txt-center copy-right">
        <p>&copy; Created By Champ Mahfuz | 2025</p>
      </div>
    </footer>
  );
}
